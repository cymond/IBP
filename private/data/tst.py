...
def set_logging():
    ...
    file_handler = logging.FileHandler("/home/pete/Documents/Python Packages/sysIB/private/data/admin/logs/reconciler.log")
...
if not os.path.isfile(dir_filename):
    ...
    '''
        ...
        positions_file = system_path + 'positions/system.csv'
