...
if __name__=="__main__":
    ...
    error_filename = source_path + 'logs/' + fileday + "download_errors" + ".csv"
    ...
    for row in new_df.itertuples():
        ...
        if datetime < today and row[6] == 0:
            ...
            if os.path.isfile(current_price_file):
                ...
                if os.path.isfile(download_price_file):
                    ...
                    if datetime in price_df.index.values and datetime in dl_price_df.index.values:
                        ...
                        print(stitched_price_df.tail(30))
                        ###***** TEMPORARY BLOCK!
            ...
            lineString = time_now + "," + row[0][0] + datetime + " not a valid stitch date!"

            print(row[0][0] + ": Stitching for date, " + datetime + ", has already been done!")
            print("============================================================")
