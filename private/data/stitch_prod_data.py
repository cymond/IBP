    ...
    if not os.path.isfile(dir_filename):
        ...
        for market in next_markets_df.itertuples():
            ...
            if yesterday >= stitch_date.date():
                ...
                quandl_price_file = source_path + "downloads/quandl/" + market.CARVER + '/' + next_price_maturity + '.csv'
                quandl_carry_file = source_path + "downloads/quandl/" + market.CARVER + '/' + next_carry_maturity + '.csv'
                ib_price_file = source_path + "downloads/ib/" + market.CARVER + '/' + next_price_maturity + '.csv'
                ib_carry_file = source_path + "downloads/ib/" + market.CARVER + '/' + next_carry_maturity + '.csv'
